    ...
    Client.setSaeClient = function (region, accessKeyID, accessKeySecret) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                 ...
                 * @returns 创建结果
                 */
                saeClient.createApplication = function (applictionObject) {
                    return __awaiter(this, void 0, void 0, function () {
                        var data;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, saeClient.request("POST", CreateApplicationUri, applictionObject, body, headers, requestOption)];
                                case 1:
                                    data = _a.sent();
                                    return [2 /*return*/, data];
                            }
                 ...
                 * @returns 部署结果
                 */
                saeClient.deployApplication = function (applictionObject) {
                    return __awaiter(this, void 0, void 0, function () {
                        var data;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, saeClient.request("POST", DeployApplicationUri, applictionObject, body, headers, requestOption)];
                                case 1:
                                    data = _a.sent();
                                    return [2 /*return*/, data];
                            }
