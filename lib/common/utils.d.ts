...
export declare function handleEnv(inputs: InputProps, application: any, credentials: any, resource: any): Promise<{
    namespace: any;
    slb: any;
}>;
export declare function handleCode(region: any, application: any, credentials: any, resource: any): Promise<any>;
