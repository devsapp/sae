...
function handleCode(Region, Application, credentials) {
    return __awaiter(this, void 0, void 0, function () {
        var AccountID, tempObject, applicationObject, code, image, codePackage, codeBucket;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 9: return [2 /*return*/, { applicationObject: applicationObject, codePackage: codePackage, tempObject: tempObject }];
            }
        });
    });
}
